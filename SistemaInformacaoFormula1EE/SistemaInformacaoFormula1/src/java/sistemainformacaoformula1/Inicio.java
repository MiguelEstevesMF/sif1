...
public class Inicio extends AbstractPageBean {
    ...
    public void prerender() {
        /*administracao_commandLink.setRendered(false);
        crono_commandLink.setRendered(false);
        gestor_commandLink.setRendered(false);
        inicio_commandLink.setRendered(false);
        juiz_commandLink.setRendered(false);
        login_commandLink.setRendered(false);
        logout_commandLink.setRendered(false);
        o_meu_perfil_commandLink.setRendered(false);
        registar_commandLink.setRendered(false);
        scoreboard_commandLink.setRendered(false);*/
    }
